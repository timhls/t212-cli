...
def test_account_summary(mock_env: None, mock_client: MagicMock) -> None:
...
def test_account_summary_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_positions_list(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
...
def test_positions_list_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_history_dividends(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
...
def test_history_dividends_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_history_orders(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"items": []}'
...
def test_history_orders_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_historical_orders.side_effect = Exception("API Error")
    result = runner.invoke(app, ["history", "orders"])
    assert result.exit_code == 0


def test_history_transactions(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"items": []}'
...
def test_history_transactions_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_historical_transactions.side_effect = Exception("API Error")
    result = runner.invoke(app, ["history", "transactions"])
    assert result.exit_code == 0


def test_metadata_exchanges(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
...
def test_metadata_exchanges_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_exchanges.side_effect = Exception("API Error")
    result = runner.invoke(app, ["metadata", "exchanges"])
    assert result.exit_code == 0


def test_metadata_instruments(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump.return_value = {"ticker": "AAPL"}
...
def test_metadata_instruments_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_instruments.side_effect = Exception("API Error")
    result = runner.invoke(app, ["metadata", "instruments"])
    assert result.exit_code == 0


def test_orders_list(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_orders.return_value = []
    result = runner.invoke(app, ["orders", "list"])
    assert result.exit_code == 0


def test_orders_list_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_orders.side_effect = Exception("API Error")
    result = runner.invoke(app, ["orders", "list"])
    assert result.exit_code == 0


def test_orders_get(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_orders_get_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_order_by_id.side_effect = Exception("API Error")
    result = runner.invoke(app, ["orders", "get", "1"])
    assert result.exit_code == 0


def test_orders_cancel(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.cancel_order.return_value = None
    result = runner.invoke(app, ["orders", "cancel", "1"])
    assert result.exit_code == 0


def test_orders_cancel_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.cancel_order.side_effect = Exception("API Error")
    result = runner.invoke(app, ["orders", "cancel", "1"])
    assert result.exit_code == 0


def test_orders_market(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_orders_market_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_pies_list_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_pies.side_effect = Exception("API Error")
    result = runner.invoke(app, ["pies", "list"])
    assert result.exit_code == 0


def test_pies_get(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_pies_get_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.get_pie_by_id.side_effect = Exception("API Error")
    result = runner.invoke(app, ["pies", "get", "1"])
    assert result.exit_code == 0


def test_pies_delete(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.delete_pie.return_value = None
    result = runner.invoke(app, ["pies", "delete", "1"])
    assert result.exit_code == 0


def test_pies_delete_error(mock_env: None, mock_client: MagicMock) -> None:
    mock_client.delete_pie.side_effect = Exception("API Error")
    result = runner.invoke(app, ["pies", "delete", "1"])
    assert result.exit_code == 0


def test_pies_create_json(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_pies_create_file(
    mock_env: None, mock_client: MagicMock, tmp_path: Any
) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
    mock_client.create_pie.return_value = mock_model
...
def test_pies_create_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_pies_update_json(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_pies_update_error(mock_env: None, mock_client: MagicMock) -> None:
...
def test_pies_duplicate_json(mock_env: None, mock_client: MagicMock) -> None:
    mock_model = MagicMock()
    mock_model.model_dump_json.return_value = '{"id": 1}'
...
def test_pies_duplicate_error(mock_env: None, mock_client: MagicMock) -> None:
